...
title: "OpenMSP"
description: >-
  Opinionated open-source defaults for Managed IT Services—processes,
  security policy templates, runbooks, SLAs, and vendor-neutral tooling you can self-host.
repository: twn-systems/openmsp
date: "2025-08-27"
published: true
---

**Status:** _In progress_ — public skeleton and initial docs shipping soon.
